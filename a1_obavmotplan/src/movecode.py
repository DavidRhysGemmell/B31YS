...
class Drive_at_block:
    ...
    def potential_field(self):
        p_0=20 #barrier around object in grid squares
        q_goal=self.goal
        F_rep=(0,0)
        k_att=1
        k_rep=1
        ...
        self.potential_force= self.max_speed/math.sqrt(pow(potential_vector[0],2)+pow(potential_vector[1],2))
        #print(self.potential_force)
